...
export default function RootLayout({children}) {
  return (
    ...
    <head>
      ...
      <meta name="description" content="Превратите свой Telegram-бот в полноценный онлайн-магазин с Magicstore"/>
      <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700;900&display=swap" rel="stylesheet"/>
      <meta name="facebook-domain-verification" content="u1q50wffgw3uky83uq0i29gb8ohog5"/>
      <Script
