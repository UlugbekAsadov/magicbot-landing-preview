...
export default function App_Showcase_Section12() {
  return (
    <>
                ...
                <article className="post post-grid">
                  ...
                  <div className="entry-content">
                    <div className="entry-category">
                      <Link href="/" title="Marketing">
                        Marketing
                      </Link>
                      <Link href="/" title="Creative">
                        Creative
                      </Link>
                    </div>
                ...
                <article className="post post-grid">
                  <div className="entry-thumbnail">
                    <Link href="/" title="How to become a web designer in 2022">
                      <img
                        src="/assets/images/post-02.jpeg"
                  ...
                  <div className="entry-content">
                    <div className="entry-category">
                      <Link href="/" title="Tutorials">
                        Tutorials
                      </Link>
                      <Link href="/" title="Ui/Ux Design">
                        Ui/Ux Design
                      </Link>
                    </div>
                    <div className="entry-title">
              ...
              <div className="col-lg-4 col-sm-12">
                <article className="post post-grid">
                  <div className="entry-thumbnail">
                    ...
                    >
                      <img
                        src="/assets/images/post-03.jpeg"
                    ...
                    <div className="entry-title">
                      <h3>
                        <Link
                          ...
                          title="20 best affiliate programs for online creators in 2022"
                        >
                          20 best affiliate programs for online creators in 2022
                        </Link>
                      </h3>
                    </div>
                  </div>
