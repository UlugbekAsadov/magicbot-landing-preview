        ...
        <div className="inner">
          <div className="main-info">
            ...
            <div className="certificates">
              <a href="/assets/images/sertificate.png">
                <Image
                  ...
                  alt="certificate"
                />
                <small>Tasdiqnoma</small>
              </a>
              <a href="/assets/images/sertificate-2.jpeg">
                <Image
                  src="/assets/images/sertificate-2.jpeg"
                  width={96}
                  height={96}
                  alt="certificate"
                />
                <small>IT Park residenti</small>
              </a>
            </div>
          </div>
